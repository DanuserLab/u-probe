...
set(handles.listbox_input, 'String', userData_main.MD(userData_main.id).getChannelPaths,...
        'Userdata', 1: length(userData_main.MD(userData_main.id).channels_));
set(handles.listbox_mask, 'String', userData_main.MD(userData_main.id).getChannelPaths,...
        'Userdata', 1: length(userData_main.MD(userData_main.id).channels_));  
