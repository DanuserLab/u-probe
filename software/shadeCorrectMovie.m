...
%                 imInfo = imfinfo([p.DarkImageDirectoriesForShadeImages{i} filesep DarkfileNames(j).name]);
%                 %%%%%%%%%%%%%%%%continue here:%%%%%%%%%%%%%%%%%%%
...
%         end
    ...
    for iChan = 1:nChanCorr
        ...
        shadeCorrDir = p.ShadeImageDirectories{iChan};
